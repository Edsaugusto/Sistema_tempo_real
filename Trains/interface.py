...
def interface(train1, train2, train3, train4):
    ...
    while running:
        ...
        # Desenhar quadrado
        pygame.draw.rect(screen, black, (200,50,400,400))

        # Desenhar a borda dos quatro retângulos da pista
        pygame.draw.rect(screen, lightgreen, (220, 70, track_width, track_height))
        pygame.draw.rect(screen, lightgreen, (410, 70, track_width, track_height))
        pygame.draw.rect(screen, lightgreen, (220, 260, track_width, track_height))
        pygame.draw.rect(screen, lightgreen, (410, 260, track_width, track_height))
        ...
        pygame.draw.rect(screen, black, (250,490,270,95))
